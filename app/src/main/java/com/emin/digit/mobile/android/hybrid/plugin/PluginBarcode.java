...
//                webView.loadUrl("javascript:" + "alert()");
    ...
    public void testSurface(PluginParams params) {
        ...
        AbsoluteLayout abLaout = new AbsoluteLayout(webView.getContext());
        Log.d(TAG, "abLayout:" + abLaout);
    ...
    public void loadBarcodeView(PluginParams params) {
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                View inflateView = layoutInflater.inflate(R.layout.barcode_capture, webView);

                Log.d(TAG, "- - - - - inflateView:" + inflateView);


                viewfinderView = (ViewfinderView) inflateView.findViewById(R.id.viewfinder_view);
                Log.d(TAG, "viewfinderView:" + viewfinderView);
                ...
                if (hasSurface) {
                    ...
                    Log.d(TAG, "will initCamera");
                    initCamera(surfaceHolder);
                } else {
                    Log.d(TAG, "will addCallback");
...
//                characterSet = null;
                ...
                if (viewfinderView.getParent() != null) {
                    Log.d(TAG, "- - - - - viewFinderView parent:" + viewfinderView.getParent());
                    Object parent = viewfinderView.getParent();
                    Class cls = parent.getClass();
                    Log.d(TAG, "cls:" + cls.toString());

                    ((ViewGroup) viewfinderView.getParent()).removeView(viewfinderView);
                } else {
                    Log.d(TAG, "viewFinderView parent is null");
                }
